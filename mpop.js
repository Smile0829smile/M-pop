...
function checkCode(){
    ...
    else if(idCode.value == "HrhnMinji"){
        document.body.style.color= "white";
        idH2.innerHTML = "Hurhun Minji <3"
        idH2.innerHTML +="<br><br><img src='IMG_2534.jpeg' width='50%' height=''>";
...
function checkCode1(){
    if(idCode1.value == "nazuke" && idCode2.value == "499630"){
        document.body.style.color= "white";
        idH2.innerHTML ="My Crush is Amina. I loved her since 6th grade <3, odoo bol mni crush Yura. 11 dugr angid bhdaa durlasn<3"
